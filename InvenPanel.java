    ...
    public void paintComponent(Graphics g){
        ...
        for (index =  0; index < player.ownedEngimon.getInv().size(); index++) {
            if(player.ownedEngimon.getInv().get(index).getElem().size() == 1){
                if(player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Fire")){g.drawImage(EngimonFire, fi*32, 0*32, this);filled[0][fi] = 1;slotEngi[0][fi] = player.ownedEngimon.getInv().get(index); fi++;}
                else if(player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Water")) {g.drawImage(EngimonWater, wi*32, 1*32, this);filled[1][wi] = 1;slotEngi[1][wi] = player.ownedEngimon.getInv().get(index);wi++;}
                ...
                else if(player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Ground")){g.drawImage(EngimonGround, gi*32, 3*32, this);filled[3][gi] = 1;slotEngi[3][gi] = player.ownedEngimon.getInv().get(index);gi++;}
                else if(player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Ice")){g.drawImage(EngimonIce, ii*32, 4*32, this);filled[4][ii] = 1;slotEngi[4][ii] = player.ownedEngimon.getInv().get(index);ii++;}
            }
            else if(player.ownedEngimon.getInv().get(index).getElem().size() == 2){
                if((player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Fire") && player.ownedEngimon.getInv().get(index).getElem().get(1).equals("Electric"))||(player.ownedEngimon.getInv().get(index).getElem().get(0) == "Electric" && player.ownedEngimon.getInv().get(index).getElem().get(1) == "Fire")){g.drawImage(EngimonFireElectric, fei*32, 5*32, this);filled[5][fei] = 1;slotEngi[5][fei] = player.ownedEngimon.getInv().get(index);fei++;}
                else if((player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Water") && player.ownedEngimon.getInv().get(index).getElem().get(1).equals("Ground"))||(player.ownedEngimon.getInv().get(index).getElem().get(0) == "Ground" && player.ownedEngimon.getInv().get(index).getElem().get(1) == "Water")){g.drawImage(EngimonWaterGround, gwi*32, 6*32, this);filled[6][gwi] = 1;slotEngi[6][gwi] = player.ownedEngimon.getInv().get(index);gwi++;}
                else if((player.ownedEngimon.getInv().get(index).getElem().get(0).equals("Water") && player.ownedEngimon.getInv().get(index).getElem().get(1).equals("Ice"))||(player.ownedEngimon.getInv().get(index).getElem().get(0) == "Ice" && player.ownedEngimon.getInv().get(index).getElem().get(1) == "Water")){g.drawImage(EngimonWaterIce, wii*32, 7*32, this);filled[7][wii] = 1;slotEngi[7][wii] = player.ownedEngimon.getInv().get(index);wii++;}
            }
        }
        // Skill
